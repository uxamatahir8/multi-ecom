...
<head>
    ...
    <link rel="stylesheet" href="<?= FRONTEND ?>css/ace-responsive-menu.css">
    ...
    <link href="<?= FRONTEND ?>images/apple-touch-icon-60x60.png" sizes="60x60" rel="apple-touch-icon">
    <link href="<?= FRONTEND ?>images/apple-touch-icon-72x72.png" sizes="72x72" rel="apple-touch-icon">
    <link href="<?= FRONTEND ?>images/apple-touch-icon-114x114.png" sizes="114x114" rel="apple-touch-icon">
    <link href="<?= FRONTEND ?>images/apple-touch-icon-180x180.png" sizes="180x180" rel="apple-touch-icon">
...
<body>
    <div class="wrapper ovh">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="header_top_widget">
                            <p class="fw500 fz13 heading-color">We provides Covid-19 medical accessories</p>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="header_top_widget footer_bottom_right_widgets">
                            <div class="social_and_help_widgets social_icon_list">
                                <ul
                                    class="mb-0 d-flex align-items-center justify-content-center justify-content-lg-end">
                                    <li class="me-0">
                                        <div class="footer_bottom_right_widgets"><select class="selectpicker show-tick">
                                                <option>English / USD</option>
                                                <option>Spanish / Euro</option>
                                    ...
                                    <li class="me-2">
                                        <div class="footer_bottom_right_widgets helpful_link_lsit">
                                            <div class="dropdown"><button class="btn dropdown-toggle" type="button"
                                                    ...
                                                    aria-expanded="false">Help Center</button>
                                                <ul class="dropdown-menu">
                                                    <li><a class="dropdown-item" href="page-help.html">Help Center</a>
                                                    </li>
                                                    <li><a class="dropdown-item" href="page-dashboard-order.html">Your
                                                            Order</a></li>
                                                    ...
                                                    <li><a class="dropdown-item" href="#">Holiday Shopping</a></li>
                                                    <li><a class="dropdown-item" href="#">Paying</a></li>
                                                    <li><a class="dropdown-item" href="#">Purchasing</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="me-2"><a href="#">Find a Store</a></li>
                                    <li class="me-2"><a href="#">Follow Us</a></li>
                ...
                <div class="row">
                    <div class="col-lg-2 col-xxl-2">
                        <div class="header_top_logo_home3">
                            <div class="logo">Zeomart<span class="text-green">.</span></div>
                        </div>
                    </div>
                    <div class="col-lg-10 col-xxl-5">
                        <div class="header_middle_advnc_search mb-4 mb-xxl-0">
                            <div class="search_form_wrapper home7_style athome8">
                                <div class="row">
                                    <div class="col-auto pr0 bgc-gmart-gray bdrs6006 pl0 ml10">
                                        <div class="actegory"><select class="selectpicker" id="selectbox_alCategory">
                                    ...
                                    <div class="col-auto p0">
                                        <div class="top-search home7_style athome8">
                                            <form action="#" method="get" class="form-search" accept-charset="utf-8">
                                                <div class="box-search pre_line before_none"><input class="form_control"
                                                        type="text" name="search" placeholder="Search products…">
                                                    <div class="search-suggestions">
                                                        <div class="box-suggestions">
                                                            <ul>
                                                                <li>
                                                                    <div class="thumb"><img src="<?= FRONTEND ?>images/listing/sf1.png"
                                                                            alt="sf1.png"></div>
                                                                ...
                                                                <li>
                                                                    <div class="thumb"><img src="<?= FRONTEND ?>images/listing/sf2.png"
                                                                            alt="sf2.png"></div>
                                                                    <div class="info-product">
                                                                        <div class="item_title">Sony E-Mount Full Frame
                                                                            FE 24-70mm f/2.8 GM II G Master</div>
                                                                        <div class="price"><span
                                                                                class="sale">$32.50</span></div>
                                                                    </div>
                                                                </li>
                                                                <li>
                                                                    <div class="thumb"><img src="<?= FRONTEND ?>images/listing/sf3.png"
                                                                            alt="sf3.png"></div>
                                                                    <div class="info-product">
                                                                ...
                                                                <li>
                                                                    <div class="thumb"><img src="<?= FRONTEND ?>images/listing/sf4.png"
                                                                            alt="sf4.png"></div>
                                                                    <div class="info-product">
                                                                ...
                                                                <li>
                                                                    <div class="thumb"><img src="<?= FRONTEND ?>images/listing/sf5.png"
                                                                            alt="sf5.png"></div>
                                                                    <div class="info-product">
                                    ...
                                    <div class="col-auto p0">
                                        <div class="advscrh_frm_btn home7_style"><button type="submit"
                                                class="btn search-btn"><span class="flaticon-search"></span></button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-xxl-5 align-self-center">
                        <div class="text-center text-xl-end">
                            <div class="wrapper d-flex justify-content-center justify-content-xxl-end"><a
                                    href="page-account-wishlist.html" class="header_iconbox_home3_style athome8 me-4">
                                    <div class="d-block d-flex align-items-center">
                                        <div class="icon me-2"><span class="flaticon-phone fz18 fw500"></span></div>
                                        <div class="details">
                                            <h5 class="title">4-956-232-0955</h5>
                                        </div>
                                    </div>
                                </a><a href="page-account-wishlist.html"
                                    class="header_iconbox_home3_style athome8 me-4">
                                    <div class="d-block d-flex align-items-center">
                                        <div class="icon me-2"><span class="flaticon-heart fz18 fw500"></span></div>
                                        <div class="details">
                                            <h5 class="title">Wishlist</h5>
                                        </div>
                                    </div>
                                </a><a href="#" class="header_iconbox_home3_style athome8 me-4 signin-filter-btn">
                                    <div class="d-block d-flex align-items-center">
                                        <div class="icon me-2"><span class="flaticon-profile fz18 fw500"></span></div>
                                        <div class="details">
                                            <h5 class="title">My Account</h5>
                                        </div>
                                    </div>
                                </a><a href="#" class="header_iconbox_home3_style athome8 cart-filter-btn">
                                    <div class="d-block d-flex align-items-center">
                                        <div class="icon me-2"><img src="<?= FRONTEND ?>images/icons/flaticon-shopping-cart.svg"
                                                alt=""><span class="badge bgc-thm rounded-circle">2</span></div>
        ...
        <header class="header-nav menu_style_home_one home8_style main-menu">
            <nav class="posr">
                <div class="container posr menu_bdrt1">
                    <div class="menu-toggle"><button type="button" id="menu-btn"><span class="icon-bar"></span><span
                                class="icon-bar"></span><span class="icon-bar"></span></button></div>
                    <div class="posr logo1">
                        <div id="mega-menu"><a class="btn-mega after_none" href="#"><img class="me-2"
                                    src="<?= FRONTEND ?>images/desktop-nav-menu-white.svg" alt="Desktop Menu Icon"><span
                                    class="fw500 fz16 color-white vam">Browse Categories</span></a>
                            <ul class="menu">
                                ...
                                <li><a class="dropdown" href="#"><span class="menu-icn flaticon-armchair"></span><span
                                            class="menu-title">Home & Furniture</span></a>
                                    <div class="drop-menu">
                                        <div class="one-third">
                                            <div class="cat-title">Electronics</div>
                                            <ul class="mb20">
                                ...
                                <li><a class="dropdown" href="#"><span
                                            class="menu-icn flaticon-smartphone-1"></span><span
                                ...
                                <li><a class="dropdown" href="#"><span
                                            class="menu-icn flaticon-bride-dress"></span><span
                                            class="menu-title">Clothing & Accessories</span></a>
                                    <div class="drop-menu">
                                        <div class="one-third">
                                            <div class="cat-title">Electronics</div>
                                            <ul class="mb20">
                                ...
                                <li><a class="dropdown" href="#"><span class="menu-icn flaticon-volleyball"></span><span
                                            class="menu-title">Sport & Outdoor</span></a>
                                    <div class="drop-menu">
                                        <div class="one-third">
                                            <div class="cat-title">Electronics</div>
                                            <ul class="mb20">
                                ...
                                <li><a class="dropdown" href="#"><span class="menu-icn flaticon-groceries"></span><span
                                            class="menu-title">Grocery & Market</span></a>
                                    <div class="drop-menu">
                                        <div class="one-third">
                                            <div class="cat-title">Electronics</div>
                                            <ul class="mb20">
                                ...
                                <li><a class="dropdown" href="#"><span
                                            class="menu-icn flaticon-remote-control"></span><span class="menu-title">Toy
                                            & Video Games</span></a>
                                    <div class="drop-menu">
                                        <div class="one-third">
                                            <div class="cat-title">Electronics</div>
                                ...
                                <li><a class="dropdown" href="#"><span
                                            class="menu-icn flaticon-feeding-bottle"></span><span
                                            class="menu-title">Babies & Moms</span></a>
                                    <div class="drop-menu">
                                        <div class="one-third">
                                            <div class="cat-title">Electronics</div>
                                            <ul class="mb20">
                                ...
                                <li class="col mega_menu_list">
                                    <div class="banner_one megamenu_style home1_style color1 mb30">
                                        <div class="thumb style1"><img class="float-end"
                                                src="<?= FRONTEND ?>images/banner/smartwatch.png" alt="smartwatch"></div>
                                        <div class="details">
                                            <p class="para color-light-blue">Starting from<span
                                                    class="fw500">$899.</span></p>
                                            <h3 class="title">Health Care Monitor</h3><a href="page-shop-list-v1.html"
                                                class="shop_btn">Shop Now</a>
                                        </div>
                                    </div>
                                    <div class="banner_one megamenu_style home1_style color1">
                                        <div class="thumb"><img class="float-end" src="<?= FRONTEND ?>images/banner/earphone.png"
                                                alt="EarPhone"></div>
                                        <div class="details">
                                            <p class="para color-light-blue">Starting from<span
                                                    class="fw500">$899.</span></p>
                                            <h3 class="title">Stainless Steel Scissors</h3><a
                                                href="page-shop-list-v1.html" class="shop_btn">Shop Now</a>
                                        </div>
                                    </div>
                                </li>
                            </ul>
                            ...
                            <li class="list-inline-item">
                                <ul class="dropdown_content">
                                    <li class="list_content">
                                        <div><img class="float-start mt10" src="<?= FRONTEND ?>images/shop/s1.png" alt="75x75">
                                            <p>Apple MacBook Pro with Apple M1 Chip</p>
                                            <div class="cart_btn home_page_sidebar mt10">
                                                <div class="quantity-block home_page_sidebar"><button
                                                        class="quantity-arrow-minus home_page_sidebar"><img
                                                            src="<?= FRONTEND ?>images/icons/minus.svg" alt=""></button><input
                                                        class="quantity-num home_page_sidebar" type="number"
                                                        value="3"><button
                                                        class="quantity-arrow-plus home_page_sidebar"><span
                                                            class="flaticon-close"></span></button></div><span
                                                    class="home_page_sidebar price">$3.399</span>
                                            </div><span class="close_icon"><i class="flaticon-close"></i></span>
                                        </div>
                                    </li>
                                    <li class="list_content">
                                        <div><img class="float-start mt10" src="<?= FRONTEND ?>images/shop/s2.png" alt="75x75">
                                            <p>Apple MacBook Pro with Apple M1 Chip</p>
                                            <div class="cart_btn home_page_sidebar mt10">
                                                <div class="quantity-block home_page_sidebar"><button
                                                        class="quantity-arrow-minus2 home_page_sidebar"><img
                                                            src="<?= FRONTEND ?>images/icons/minus.svg" alt=""></button><input
                                                        class="quantity-num2 home_page_sidebar" type="number"
                                                        value="3"><button
                                                        class="quantity-arrow-plus2 home_page_sidebar"><span
                                                            class="flaticon-close"></span></button></div><span
                                                    class="home_page_sidebar price">$3.399</span>
                                            </div><span class="close_icon"><i class="flaticon-close"></i></span>
                                        </div>
                    ...
                    <div class="lc">
                        ...
                        <div class="uilayout_range home1_style">
                            <div class="sidebar_range_slider mb30 mt25"><input class="range-example-km" value="80"
                                    type="text"></div>
                        </div><a href="#" class="cart_btns btn btn-white">View Cart</a><a href="#"
                ...
                <div class="header stylehome1 home8_style">
                    <div class="menu_and_widgets">
                        <div class="mobile_menu_bar float-start"><a class="menubar" href="#menu"><span></span></a><a
                                class="mobile_logo" href="#">Zeomart<span class="text-thm">.</span></a></div>
                        <div class="mobile_menu_widget_icons">
                            <ul class="cart mt15">
                                ...
                                <li class="list-inline-item"><a class="cart_btn cart-filter-btn" href="#"><span
                                            class="icon"><img src="<?= FRONTEND ?>images/icons/flaticon-shopping-cart-white.svg"
                                ...
                                <div class="row">
                                    <div>
                                        <div class="top-search text-start">
                                            <form action="#" method="get" class="form-search" accept-charset="utf-8">
                                                <div class="box-search"><input class="form_control" type="text"
                                    ...
                                    <div>
                                        <div class="advscrh_frm_btn"><button type="submit" class="btn search-btn"><span
                                                    class="flaticon-search"></span></button></div>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="body_content_wrapper position-relative pt30">
            <section class="home-one">
                <div class="container">
                    <div class="row">
                        <div class="col-xl-8">
                            <div
                                class="navi_pagi_bottom_left athome8 main-banner-wrapper home1_style bdrs6 ovh mb-4 mb-xl-0">
                                <div class="banner-style-one owl-theme owl-carousel">
                                    <div class="slide slide-one banner_home8_slider"
                                        style="background-color:#eff6f9;background-position:center;height:570px">
                                        <div class="container">
                                            <div class="row">
                                                <div class="col-lg-7 ps-3 ps-sm-5"><span class="tag home8_style">Covid
                                                        -19 Products</span>
                                                    <h3 class="banner-title"><span class="fw400">COVID-19
                                                            Prevention</span><br class="dn-414"><span
                                                            class="color-light-blue">& Care Supplies</span></h3>
                                                    <p class="heading-color">Collection of products that help you to
                                                        protect you and<br class="dn-414">your beloved. Take a good deal
                                                        TODAY</p><a href="page-shop-cart.html"
                                                        class="btn banner-btn home8_banner_btn btn-thm1">Shop Now</a>
                                                </div>
                                                <div class="col-lg-5 d-none d-lg-block">
                                                    <div class="animate_content text-center text-xl-start zi1"><img
                                                            class="offbanenr_3" src="<?= FRONTEND ?>images/banner/off-banner3.png"
                                                            alt="">
                                                        <div class="animate_thumb"><img
                                                                src="<?= FRONTEND ?>images/banner/thermometer-facemask.png"
                                                                alt="Home 8 Product"></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="col-xl-4">
                            <div class="banner_one home1_style color1 mb30">
                                <div class="thumb style1"><img class="float-end" src="<?= FRONTEND ?>images/banner/earphone.png"
                                        alt="earphone"></div>
                                <div class="details">
                                    <p class="para color-light-blue">Starting from<span class="fw500">$899.</span></p>
                                    <h3 class="title">Stainless Steel Scissors</h3><a href="page-shop-list-v1.html"
                                        class="shop_btn">Shop Now</a>
                                </div>
                            </div>
                            <div class="banner_one home1_style color2 mb30">
                                <div class="thumb style1"><img class="float-end" src="<?= FRONTEND ?>images/banner/smartdevice.png"
                                        alt="SmartDevice">
                                    <div class="off_banner"><img src="<?= FRONTEND ?>images/banner/off-banner.png" alt="Off Banner">
                                    </div>
                                </div>
                                <div class="details">
                                    <p class="para color-light-blue">Starting from<span class="fw500">$899.</span></p>
                                    <h3 class="title">Blood Pressure Meter</h3><a href="page-shop-list-v1.html"
                                        class="shop_btn">Shop Now</a>
                                </div>
                            </div>
                        </div>
            ...
            <section class="top-category pb60 pt70">
                <div class="container">
                    <div class="row">
                        <div class="col-sm-6">
                        ...
                        <div class="col-sm-6">
                            <div class="main-title text-center text-sm-end mb-5"><a class="title_more_btn mt10"
                                    href="page-shop-list-v2.html">View All Categories</a></div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="shop_item_6grid_slider nav_none dots_none">
                                <div class="item"><a href="page-shop-list-v6.html">
                                        <div class="iconbox">
                                            <div class="icon"><img src="<?= FRONTEND ?>images/shop-items/ct20.png"
                                                    alt="Category Image"></div>
                                            <div class="details">
                                                <h5 class="title">Hospital Equipment</h5>
                                ...
                                <div class="item"><a href="page-shop-list-v6.html">
                                        <div class="iconbox">
                                            <div class="icon"><img src="<?= FRONTEND ?>images/shop-items/ct21.png"
                                                    alt="Category Image"></div>
                                            <div class="details">
                                                <h5 class="title">Blood Pressure</h5>
                                                <p class="subtitle">29 items</p>
                                            </div>
                                        </div>
                                    </a></div>
                                <div class="item"><a href="page-shop-list-v6.html">
                                        <div class="iconbox">
                                            <div class="icon"><img src="<?= FRONTEND ?>images/shop-items/ct22.png"
                                                    alt="Category Image"></div>
                                            <div class="details">
                                ...
                                <div class="item"><a href="page-shop-list-v6.html">
                                        <div class="iconbox">
                                            <div class="icon"><img src="<?= FRONTEND ?>images/shop-items/ct23.png"
                                                    alt="Category Image"></div>
                                            <div class="details">
                                ...
                                <div class="item"><a href="page-shop-list-v6.html">
                                        <div class="iconbox">
                                            <div class="icon"><img src="<?= FRONTEND ?>images/shop-items/ct24.png"
                                                    alt="Category Image"></div>
                                            <div class="details">
                                                <h5 class="title">Independent Living</h5>
                                                <p class="subtitle">29 items</p>
                                            </div>
                                        </div>
                                    </a></div>
                                <div class="item"><a href="page-shop-list-v6.html">
                                        <div class="iconbox">
                                            <div class="icon"><img src="<?= FRONTEND ?>images/shop-items/ct25.png"
                                                    alt="Category Image"></div>
                                            <div class="details">
            ...
            <section class="deal-of-the-day pt0">
                <div class="container">
                    <div class="deal_large_widget">
                        <div class="row">
                            <div class="col-md-10 col-lg-7 col-xl-6 col-xxl-5 m-auto">
                                <div
                                    class="main-title text-center d-block d-md-flex justify-content-center bgc-white mt-50 mt0-sm">
                                    <h2 class="">Top Deals Of The Day</h2>
                                    <div class="deal_countdown">
                                        <ul class="deal_counter home7_style bgc-thm ml0-sm" id="timer">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="home8_deal_of_the_day popular_listing_sliders">
                                    <div class="shop_item_5grid_slider dots_none">
                                        <div class="item">
                                            <div class="shop_item home8_style line_clip_less">
                                                <div class="thumb pb30"><img src="<?= FRONTEND ?>images/shop-items/shop-item120.png"
                                                    ...
                                                    <div class="shop_item_cart_btn d-grid"><a href="page-shop-cart.html"
                                                            class="btn btn-thm1">Add to Cart</a></div>
                                                </div>
                                                <div class="details">
                                                    <div class="sub_title">Fruits & Vegs</div>
                                                    <div class="title"><a href="page-shop-single-v1.html">Ergonomic
                                                            Concrete<br>Lamp</a></div>
                                        ...
                                        <div class="item">
                                            <div class="shop_item home8_style line_clip_less">
                                                <div class="thumb pb30"><img src="<?= FRONTEND ?>images/shop-items/shop-item121.png"
                                                        alt="Electronics Product">
                                                    <div class="thumb_info">
                                                        <ul class="mb0">
                                                            <li><a href="page-dashboard-wish-list.html"><span
                                                ...
                                                <div class="details">
                                                    <div class="sub_title">Fruits & Vegs</div>
                                                    <div class="title"><a href="page-shop-single-v1.html">Heinz Tomato
                                                            Ketchup<br>460g</a></div>
                                                    <div class="review d-flex">
                                                        <ul class="mb0 me-2">
                                                            <li class="list-inline-item"><a href="#"><i
                                                                        class="fas fa-star"></i></a></li>
                                        ...
                                        <div class="item">
                                            <div class="shop_item home8_style line_clip_less">
                                                <div class="thumb pb30"><img src="<?= FRONTEND ?>images/shop-items/shop-item122.png"
                                                        alt="Electronics Product">
                                                    <div class="thumb_info">
                                                        <ul class="mb0">
                                                            <li><a href="page-dashboard-wish-list.html"><span
                                        ...
                                        <div class="item">
                                            <div class="shop_item home8_style line_clip_less">
                                                <div class="thumb pb30"><img src="<?= FRONTEND ?>images/shop-items/shop-item116.png"
                                                        alt="Electronics Product">
                                                    <div class="thumb_info">
                                                        <ul class="mb0">
                                                            <li><a href="page-dashboard-wish-list.html"><span
                                        ...
                                        <div class="item">
                                            <div class="shop_item home8_style line_clip_less">
                                                <div class="thumb pb30"><img src="<?= FRONTEND ?>images/shop-items/shop-item111.png"
                                                        alt="Electronics Product">
                                                    <div class="thumb_info">
                                                        <ul class="mb0">
                                                            <li><a href="page-dashboard-wish-list.html"><span
                                                ...
                                                <div class="details">
                                                    ...
                                                    <div class="title"><a href="page-shop-single-v1.html">Pre-Owned
                                                            Rolex Day-date 1802 Gold Watch (Certified Authenti...</a>
                                                    </div>
                                                    <div class="review d-flex">
                                                        <ul class="mb0 me-2">
                                                            <li class="list-inline-item"><a href="#"><i
            ...
            <section class="featured-product pb70 pt0">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6 col-xl-4">
                            <div class="banner_one home1_style color2 mb30">
                                <div class="thumb style1"><img class="float-end" src="<?= FRONTEND ?>images/banner/thermometer.png"
                                        alt="Thermometer"></div>
                                <div class="details">
                                    <p class="para color-light-blue">Starting from<span class="fw500">$899.</span></p>
                                    <h3 class="title">Ear Thermometers</h3><a href="page-shop-list-v1.html"
                                        class="shop_btn">Shop Now</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 col-xl-4">
                            <div class="banner_one home1_style color6 mb30">
                                <div class="thumb style1"><img class="float-end" src="<?= FRONTEND ?>images/banner/sanitizer.png"
                                        alt="Sanitizer"></div>
                                <div class="details">
                                    <p class="para color-light-blue">Starting from<span class="fw500">$899.</span></p>
                                    <h3 class="title">Hand Sanitizer Package</h3><a href="page-shop-list-v1.html"
                                        class="shop_btn">Shop Now</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 col-xl-4">
                            <div class="banner_one home1_style color7 mb30">
                                <div class="thumb"><img class="float-end" src="<?= FRONTEND ?>images/banner/fmask.png" alt="Face Mask">
                                    <div class="off_banner"><img src="<?= FRONTEND ?>images/banner/off-banner.png" alt="Off Banner">
                                    </div>
                                </div>
                                <div class="details">
                                    <p class="para color-light-blue">Starting from<span class="fw500">$899.</span></p>
                                    <h3 class="title">Covid Mask</h3><a href="page-shop-list-v1.html"
                                        class="shop_btn">Shop Now</a>
                                </div>
                            </div>
                        </div>
            ...
            <section class="featured-product pb80 pt0">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-5">
                        ...
                        <div class="col-lg-7">
                            <div class="popular_listing_sliders ui_kit_tab style2">
                                <div class="nav nav-tabs mb30 justify-content-center justify-content-lg-end"
                                    role="tablist"><button class="nav-link active" id="nav-t20-tab" data-bs-toggle="tab"
                                        data-bs-target="#nav-t20" role="tab" aria-controls="nav-t20"
                                        aria-selected="true">Top 20</button><button class="nav-link"
                                        id="nav-bselelr-tab" data-bs-toggle="tab" data-bs-target="#nav-bselelr"
                                        role="tab" aria-controls="nav-bselelr" aria-selected="false">Best
                                        Seller</button><button class="nav-link" id="nav-sales-tab" data-bs-toggle="tab"
                                        data-bs-target="#nav-sales" role="tab" aria-controls="nav-sales"
                                        aria-selected="false">Sale</button><button class="nav-link me-0"
                        ...
                        <div class="col-lg-12">
                            <div class="popular_listing_sliders row ui_kit_tab style2">
                                <div class="tab-content col-lg-12" id="nav-tabContent3">
                                    <div class="tab-pane fade show active" id="nav-t20" role="tabpanel"
                                        aria-labelledby="nav-t20-tab">
                                        <div class="row">
                                            <div class="col-sm-6 col-lg-4 col-xl px-2 px-sm-0">
                                                <div class="shop_item home8_style line_clip_less">
                                                    <div class="thumb pb30"><img
                                                            src="<?= FRONTEND ?>images/shop-items/shop-item110.png"
                                                        ...
                                                        <div class="shop_item_cart_btn d-grid"><a
                                                                href="page-shop-cart.html" class="btn btn-thm1">Add to
                                                                Cart</a></div>
                                                    </div>
                                                    <div class="details">
                                                        <div class="sub_title body-color">SONY</div>
                                                        <div class="title"><a href="page-shop-single-v1.html">Shure
                                                                SRH440 Professional Studio Headphones</a></div>
                                                        <div class="review d-flex">
                                                            <ul class="mb0 me-2">
                                                                <li class="list-inline-item"><a href="#"><i
                                                                            class="fas fa-star"></i></a></li>
                                                ...
                                                <div class="shop_item home8_style line_clip_less">
                                                    <div class="thumb pb30"><img
                                                            src="<?= FRONTEND ?>images/shop-items/shop-item111.png"
                                                            alt="Featured Products">
                                                        <div class="thumb_info">
                                                            <ul class="mb0">
                                                                <li><a href="page-dashboard-wish-list.html"><span
                                            ...
                                            <div class="col-sm-6 col-lg-4 col-xl px-2 px-sm-0">
                                                <div class="shop_item home8_style line_clip_less">
                                                    <div class="thumb pb30"><img
                                                            src="<?= FRONTEND ?>images/shop-items/shop-item112.png"
                                                            alt="Electronics Product">
                                                        <div class="thumb_info">
                                                            <ul class="mb0">
                                                                <li><a href="page-dashboard-wish-list.html"><span
                                                ...
                                                <div class="shop_item home8_style line_clip_less">
                                                    <div class="thumb pb30"><img
                                                            src="<?= FRONTEND ?>images/shop-items/shop-item113.png"
                                                            alt="Electronics Product">
                                                        <div class="thumb_info">
                                                            <ul class="mb0">
                                                                <li><a href="page-dashboard-wish-list.html"><span
                                            ...
                                            <div class="col-sm-6 col-lg-4 col-xl px-2 px-sm-0">
                                                <div class="shop_item home8_style line_clip_less">
                                                    <div class="thumb pb30"><img
                                                            src="<?= FRONTEND ?>images/shop-items/shop-item114.png"
                                                            alt="Electronics Product">
                                                        <div class="thumb_info">
                                                            <ul class="mb0">
                                                                <li><a href="page-dashboard-wish-list.html"><span
                                                ...
                                                <div class="shop_item home8_style line_clip_less">
                                                    <div class="thumb pb30"><img
                                                            src="<?= FRONTEND ?>images/shop-items/shop-item115.png"
                                                            alt="Electronics Product">
                                                        <div class="thumb_info">
                                                            <ul class="mb0">
                                                                <li><a href="page-dashboard-wish-list.html"><span
                                            ...
                                            <div class="col-sm-6 col-lg-4 col-xl px-2 px-sm-0">
                                                <div class="shop_item home8_style line_clip_less">
                                                    <div class="thumb pb30"><img
                                                            src="<?= FRONTEND ?>images/shop-items/shop-item116.png"
                                                            alt="Electronics Product">
                                                        <div class="thumb_info">
                                                            <ul class="mb0">
                                                                <li><a href="page-dashboard-wish-list.html"><span
                                                ...
                                                <div class="shop_item home8_style line_clip_less">
                                                    <div class="thumb pb30"><img
                                                            src="<?= FRONTEND ?>images/shop-items/shop-item117.png"
                                                            alt="Electronics Product">
                                                        <div class="thumb_info">
                                                            <ul class="mb0">
                                                                <li><a href="page-dashboard-wish-list.html"><span
                                            ...
                                            <div class="col-sm-6 col-lg-4 col-xl px-2 px-sm-0">
                                                <div class="shop_item home8_style line_clip_less">
                                                    <div class="thumb pb30"><img
                                                            src="<?= FRONTEND ?>images/shop-items/shop-item118.png"
                                                            alt="Electronics Product">
                                                        <div class="thumb_info">
                                                            <ul class="mb0">
                                                                <li><a href="page-dashboard-wish-list.html"><span
                                                ...
                                                <div class="shop_item home8_style line_clip_less">
                                                    <div class="thumb pb30"><img
                                                            src="<?= FRONTEND ?>images/shop-items/shop-item119.png"
                                                            alt="Electronics Product">
                                                        <div class="thumb_info">
                                                            <ul class="mb0">
                                                                <li><a href="page-dashboard-wish-list.html"><span
                                    ...
                                    <div class="tab-pane fade" id="nav-bselelr" role="tabpanel"
                                        aria-labelledby="nav-bselelr-tab"></div>
                                    <div class="tab-pane fade" id="nav-sales" role="tabpanel"
                                        aria-labelledby="nav-sales-tab"></div>
                                    <div class="tab-pane fade" id="nav-featured" role="tabpanel"
                                        aria-labelledby="nav-featured-tab"></div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <section class="our-testimonials home8_style pb70">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-5">
                            <div class="main-title">
                                <h2 class="title fw600 mb20">What our customers are<br>saying us?</h2>
                            ...
                            <div class="d-flex mt60">
                                <div class="funfact_one home8_style me-5">
                                    <div class="details">
                                        <ul>
                                            <li class="list-inline-item">
                                ...
                                <div class="funfact_one home8_style ms-5">
                                    <div class="details">
                                        <ul>
                                            <li class="list-inline-item">
                                                <div class="timer">4.88</div>
                                            </li>
                                        </ul>
                                        ...
                                        <div class="sspd_postdate">
                                            <div class="sspd_review">
                                                <ul class="mb0">
                                                    <li class="list-inline-item"><a href="#"><i
                                                                class="fas fa-star color-light-blue"></i></a></li>
                                                    <li class="list-inline-item"><a href="#"><i
                                                                class="fas fa-star color-light-blue"></i></a></li>
                                                    <li class="list-inline-item"><a href="#"><i
                                                                class="fas fa-star color-light-blue"></i></a></li>
                        ...
                        <div class="col-lg-6 offset-lg-1">
                            <div class="swiper mySwiper ms-0 ms-lg-5 mb30">
                                <div class="swiper-wrapper mb-5">
                                    <div class="swiper-slide" data-swiper-slide-index="00">
                                        <div class="testimonial_item">
                                            <div class="d-flex align-items-center mb30">
                                                <div class="flex-shrink-0"><img src="<?= FRONTEND ?>images/team/testimonials1.png"
                                                        alt="Testimonials Images"></div>
                                                <div class="flex-grow-1 ms-4">
                                                    <h5 class="author">Annette Black</h5>
                                                    <h6 class="author_post">UX / UI Designer</h6>
                                                </div>
                                            </div>
                                            <h4 class="tstmnl_slider_para">The place is in a great location in Gumbet.
                                                The area is safe and beautiful. The apartment was comfortable and the
                                                host was kind and responsive to our requests.</h4>
                                        </div>
                                    </div>
                                    ...
                                    <div class="swiper-slide swiper-slide-prev" data-swiper-slide-index="03">
                                        <div class="testimonial_item">
                                            <div class="d-flex align-items-center mb30">
                                                <div class="flex-shrink-0"><img src="<?= FRONTEND ?>images/team/testimonials1.png"
                                                        alt="Testimonials Images"></div>
                                    ...
                                    <div class="swiper-slide swiper-slide-active" data-swiper-slide-index="04">
                                        <div class="testimonial_item">
                                            <div class="d-flex align-items-center mb30">
                                                <div class="flex-shrink-0"><img src="<?= FRONTEND ?>images/team/testimonials1.png"
                                                        alt="Testimonials Images"></div>
                                ...
                                <div class="swpr_paginations mt30">
                                    <div class="slideactive">01</div>
                                    <div class="slidetotal">05</div>
                                </div>
                                <div class="posr mt-4">
                                    <div class="swpr_custom_prgrsba swiper-pagination swiper-pagination-progressbar">
            ...
            <section class="our-partners pb60">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-2">
                            <div class="partner_item mb30-sm"><img src="<?= FRONTEND ?>images/partners/1.png" alt="1.png"></div>
                        </div>
                        <div class="col-sm-6 col-md-4 col-lg-2">
                            <div class="partner_item mb30-sm"><img src="<?= FRONTEND ?>images/partners/2.png" alt="2.png"></div>
                        </div>
                        <div class="col-sm-6 col-md-4 col-lg-2">
                            <div class="partner_item mb30-sm"><img src="<?= FRONTEND ?>images/partners/3.png" alt="3.png"></div>
                        </div>
                        <div class="col-sm-6 col-md-4 col-lg-2">
                            <div class="partner_item mb30-sm"><img src="<?= FRONTEND ?>images/partners/4.png" alt="4.png"></div>
                        </div>
                        <div class="col-sm-6 col-md-4 col-lg-2">
                            <div class="partner_item mb30-sm"><img src="<?= FRONTEND ?>images/partners/5.png" alt="5.png"></div>
                        </div>
                        <div class="col-sm-6 col-md-4 col-lg-2">
                            <div class="partner_item mb30-sm"><img src="<?= FRONTEND ?>images/partners/6.png" alt="6.png"></div>
                        </div>
                    </div>
                </div>
            </section>
            <section class="our-blog pt0 pb70">
                <div class="container">
                    <div class="row">
                        <div class="col-sm-6">
                        ...
                        <div class="col-sm-6">
                            <div class="main-title text-center text-sm-end mb-5"><a class="title_more_btn mt10"
                                    href="page-shop-list-v2.html">See All</a></div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-6 col-lg-4 col-xl-2">
                            <div
                                class="shop_item home8_style line_clip_less small_font px-2 py-3 text-center text-sm-start">
                                <div class="thumb pb30"><img src="<?= FRONTEND ?>images/shop-items/shop-item104.png"
                                        alt="Recent View Product">
                                    <div class="thumb_info">
                                        <ul class="mb0">
                                            <li><a href="page-dashboard-wish-list.html"><span
                                                        class="flaticon-heart"></span></a></li>
                                ...
                                <div class="details">
                                    ...
                                    <div class="title"><a href="page-shop-single-v1.html">Great Value Ultra Strong Paper
                                            Towels, Split Sheets</a></div>
                        ...
                        <div class="col-sm-6 col-lg-4 col-xl-2">
                            <div
                                class="shop_item home8_style line_clip_less small_font px-2 py-3 text-center text-sm-start">
                                <div class="thumb pb30"><img src="<?= FRONTEND ?>images/shop-items/shop-item105.png"
                                        alt="Recent View Product">
                                    <div class="thumb_info">
                                        <ul class="mb0">
                                            <li><a href="page-dashboard-wish-list.html"><span
                                ...
                                <div class="details">
                                    <div class="sub_title body-color">SONY</div>
                                    <div class="title"><a href="page-shop-single-v1.html">KINLO Hydrating Golden Facial
                                            Mist with Sweet</a></div>
                                    <div class="review d-flex justify-content-center justify-content-sm-start">
                                        <ul class="mb0 me-2">
                                            <li class="list-inline-item"><a href="#"><i class="fas fa-star"></i></a>
                                            </li>
                        ...
                        <div class="col-sm-6 col-lg-4 col-xl-2">
                            <div
                                class="shop_item home8_style line_clip_less small_font px-2 py-3 text-center text-sm-start">
                                <div class="thumb pb30"><img src="<?= FRONTEND ?>images/shop-items/shop-item106.png"
                                        alt="Recent View Product">
                                    <div class="thumb_info">
                                        <ul class="mb0">
                                            <li><a href="page-dashboard-wish-list.html"><span
                                ...
                                <div class="details">
                                    <div class="sub_title body-color">SONY</div>
                                    <div class="title"><a href="page-shop-single-v1.html">Graco SlimFit 3-in-1 Car Seat,
                                            Saves Space in Your</a></div>
                                    <div class="review d-flex justify-content-center justify-content-sm-start">
                                        <ul class="mb0 me-2">
                                            <li class="list-inline-item"><a href="#"><i class="fas fa-star"></i></a>
                                            </li>
                        ...
                        <div class="col-sm-6 col-lg-4 col-xl-2">
                            <div
                                class="shop_item home8_style line_clip_less small_font px-2 py-3 text-center text-sm-start">
                                <div class="thumb pb30"><img src="<?= FRONTEND ?>images/shop-items/shop-item107.png"
                                        alt="Recent View Product">
                                    <div class="thumb_info">
                                        <ul class="mb0">
                                            <li><a href="page-dashboard-wish-list.html"><span
                                ...
                                <div class="details">
                                    ...
                                    <div class="title"><a href="page-shop-single-v1.html">Decathlon Rockrider ST100, 21
                                            Speed Mountain Bike,</a></div>
                                    <div class="review d-flex justify-content-center justify-content-sm-start">
                                        <ul class="mb0 me-2">
                                            <li class="list-inline-item"><a href="#"><i class="fas fa-star"></i></a>
                                            </li>
                        ...
                        <div class="col-sm-6 col-lg-4 col-xl-2">
                            <div
                                class="shop_item home8_style line_clip_less small_font px-2 py-3 text-center text-sm-start">
                                <div class="thumb pb30"><img src="<?= FRONTEND ?>images/shop-items/shop-item108.png"
                                        alt="Recent View Product">
                                    <div class="thumb_info">
                                        <ul class="mb0">
                                            <li><a href="page-dashboard-wish-list.html"><span
                                ...
                                <div class="details">
                                    ...
                                    <div class="title"><a href="page-shop-single-v1.html">Marketside Large Cage Free
                                            Brown Eggs, 36 Oz, 18 Ct</a></div>
                                    <div class="review d-flex justify-content-center justify-content-sm-start">
                                        <ul class="mb0 me-2">
                                            <li class="list-inline-item"><a href="#"><i class="fas fa-star"></i></a>
                                            </li>
                        ...
                        <div class="col-sm-6 col-lg-4 col-xl-2">
                            <div
                                class="shop_item home8_style line_clip_less small_font px-2 py-3 text-center text-sm-start">
                                <div class="thumb pb30"><img src="<?= FRONTEND ?>images/shop-items/shop-item109.png"
                                        alt="Recent View Product">
                                    <div class="thumb_info">
                                        <ul class="mb0">
                                            <li><a href="page-dashboard-wish-list.html"><span
                                ...
                                <div class="details">
                                    <div class="sub_title">rolex</div>
                                    <div class="title"><a href="page-shop-single-v1.html">Yaheetech Lift Top Coffee
                                            Table w/Hidden Storage</a></div>
                                    <div class="review d-flex justify-content-center justify-content-sm-start">
                                        <ul class="mb0 me-2">
                                            <li class="list-inline-item"><a href="#"><i class="fas fa-star"></i></a>
                                            </li>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-xl-4">
                            <div class="for_blog">
                                <div class="thumb"><img class="img-whp" src="<?= FRONTEND ?>images/blog/31.jpg" alt="31.jpg"></div>
                                <div class="details">
                                    <div class="tc_content"><span class="subtitle">Tips & Tricks</span>
                                        <h4 class="title"><a href="#">Collar brings back coffee brewing ritual</a></h4>
                                        <span class="post_date">April 06, 2022</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 col-xl-4">
                            <div class="for_blog">
                                <div class="thumb"><img class="img-whp" src="<?= FRONTEND ?>images/blog/32.jpg" alt="32.jpg"></div>
                                <div class="details">
                                    <div class="tc_content"><span class="subtitle">Tips & Tricks</span>
                                        <h4 class="title"><a href="#">Furniture that explores wood as material</a></h4>
                                        <span class="post_date">April 06, 2022</span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6 col-xl-4">
                            <div class="for_blog">
                                <div class="thumb"><img class="img-whp" src="<?= FRONTEND ?>images/blog/33.jpg" alt="33.jpg"></div>
                                <div class="details">
                                    <div class="tc_content"><span class="subtitle">Tips & Tricks</span>
                                        <h4 class="title"><a href="#">Renaissance of the wall clock</a></h4><span
                                            class="post_date">April 06, 2022</span>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <section class="our-features pt0 pb60">
                <div class="container">
                    <div class="row">
                ...
                <div class="container pb60">
                    <div class="row">
                        <div class="col-lg-6 offset-lg-3">
                            <div class="mailchimp_widget home2_style mb30-md text-center">
                            ...
                            <div class="footer_social_widget">
                                <form class="footer_mailchimp_form home2_style">
                                    <div class="row align-items-center">
                                        <div class="col-auto"><input type="email" class="form-control"
                                                placeholder="Your email address"><button class="ms-sm-2 btn-thm"
                    ...
                    <div class="row mt60">
                            ...
                            <div class="footer_contact_widget home2_style">
                                ...
                                <div class="footer_contact_iconbox home2_style d-flex mb-4">
                                    ...
                                    <div class="details ms-4">
                                        <h5 class="title">Monday-Friday: 08am-9pm</h5><a href="#">+(1) 123 456 7890</a>
                                    </div>
                                </div>
                                <div class="footer_contact_iconbox home2_style d-flex">
                                    <div class="icon"><span class="flaticon-email"></span></div>
                                    <div class="details ms-4">
                                        <h5 class="title">Need help with your order?</h5><a
                                            href="#">support@zeomart.com</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-8 col-md-5 col-lg-3 col-xl-3">
                            <div class="footer_social_widget home2_style">
                                <h4 class="title">Follow us</h4>
                                <div class="social_icon_list home2_style mt30">
                                    <ul class="mb20">
                            ...
                            <div class="footer_mobile_app_widget mb25 home2_style">
                            ...
                            <div class="footer_acceped_card_widget home2_style">
                                <h4 class="title mb20">We accept</h4>
                                <div class="acceped_card_list">
                                    <ul class="d-flex mb-0">
                                        <li class="me-2"><a href="#"><img src="<?= FRONTEND ?>images/resource/visa-card.png"
                                                    alt="visa-card"></a></li>
                                        <li class="me-2"><a href="#"><img src="<?= FRONTEND ?>images/resource/master-card.png"
                                                    alt="master-card"></a></li>
                                        <li class="me-2"><a href="#"><img src="<?= FRONTEND ?>images/resource/apple-pay.png"
                                                    alt="apple-pay"></a></li>
                                        <li class="me-2"><a href="#"><img src="<?= FRONTEND ?>images/resource/discover-card.png"
                                                    alt="discover-card"></a></li>
                                        <li class="me-2"><a href="#"><img src="<?= FRONTEND ?>images/resource/paypal.png"
                                                    alt="paypal"></a></li>
                                        <li><a href="#"><img src="<?= FRONTEND ?>images/resource/amex-card.png" alt="amex-card"></a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="footer_bottom_right_widgets home2_style text-center text-lg-end">
                                <ul class="mb0">
                                    <li class="list-inline-item mb20-340"><select class="selectpicker show-tick">
            ...
            </section><a class="scrollToHome" href="#"><i class="fas fa-angle-up"></i></a>
        </div>
    </div>
    <script src="<?= FRONTEND ?>js/jquery-3.6.0.js"></script>
    ...
    <script src="<?= FRONTEND ?>js/jquery.mmenu.all.js"></script>
    <script src="<?= FRONTEND ?>js/ace-responsive-menu.js"></script>
    <script src="<?= FRONTEND ?>js/jquery-scrolltofixed-min.js"></script>
    <script src="<?= FRONTEND ?>js/slider.js"></script>
    <script src="<?= FRONTEND ?>js/scrollbalance.js"></script>
